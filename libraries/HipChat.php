...
class HipChat {
   ...
   *
   * @param array $params auth_token:   Your API token.
   *                      api_target:   API protocol and host. Change if you're using an API
  ...
  function __construct($params) {
    ...
    $this->api_target = isset($params['api_target']) ? $params['api_target'] : self::DEFAULT_TARGET;
    $this->api_version = isset($params['api_version']) ? $params['api_version'] : self::VERSION_1;
  }
