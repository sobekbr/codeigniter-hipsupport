...
$config['hipsupport'] = array(
	...
	*/
	...
	|--------------------------------------------------------------------------
	|
	| Which cache adapter to use when storing the "live chat online" data.
	| Can be 'apc', 'memcached', or 'file'
	|
...
/* Location: ./application/config/hipsupport.php */
